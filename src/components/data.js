const questions = [
  ...
  {
    id: 4,
    title: "Wie gehst du mit Änderungen an einem Projekt um?",
    info: "Die kleinen Änderungen, die problemlos umsetzbar sind, sind auch kein Thema aber die Änderungen, die groß und zeitaufwendig sind z.b. Änderungen von Projekt-Komponenten oder die Funktionsweise des UI/UX-Designs müssen erst mit dem Team besprochen werden, wenn es nicht allen ein Problem bereitet, dann bereitet es mir auch kein Problem.",
  },
  {
    id: 5,
    title:
      "Mit welchen 3 (Charakter-) Eigenschaften würdest du dich beschreiben? - Was zeichnet dich als Mensch und im Arbeiten aus?",
